...
app.controller('giftCtrl', ["$scope", "$uibModal","SweetAlert","restSessionOut", function ($scope, $uibModal,SweetAlert,restSessionOut) {
...
app.controller('ModalServiceCtrl', ["$scope", "$uibModalInstance", "items", function ($scope, $uibModalInstance, items) {
