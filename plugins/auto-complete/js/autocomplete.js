    ...
    controller: ['$scope', function($scope){
      ...
      $scope.select = function(suggestion){
        if(suggestion){
          ...
          $scope.searchFilter = (typeof(suggestion) === "object") ? suggestion.name : suggestion;
          if($scope.onSelect)
...
app.filter('highlight', ['$sce', function ($sce) {
  return function (input, searchParam) {
    //input = input.name + ' - ' + input.company;
    input = input.company;
    searchParam = (typeof(searchParam) === "object") ? searchParam.name : searchParam;
